...
public class Tallyer {
  ...
  public static Map<String, Integer> tallyTopicsFiltered(List<String> ids, List<String> topics) {
    ...
    Map<String, Integer> studentCheck = tallyTopics(topics);
    Map<String, Integer> filteredStudents = tallyTopics(topics);
    ...
    /*for (String id : ids) {
        if (!studentCheck.containsKey(id) && !filteredStudents.containsKey(topic)) {
          ...
          int updatedStudentCount = studentCheck.get(id) + 1;
          int updatedTopicCount = filteredStudents.get(topic) + 1;

          studentCheck.put(id, updatedStudentCount);
          filteredStudents.put(topic, updatedTopicCount);
        }
      }
